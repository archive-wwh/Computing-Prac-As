#NOTE: DO NOT DEPEND ON THIS TO LEARN ABOUT PYTHON FROM SCRATCH, THIS IS ONLY FOR REFINEMENT WHEN YOU HAVE A ROUGH UNDERSTANDING
...
#turtle (a bit useless for a level h2 computing)
#draw in shell/ console
import turtle #import turtle library
turtle_object = turtle.Turtle() #create object
turtle_object.shape('turtle') #change to turtle shape
turtle_object.shapesize(1) #change size
turtle_object.color('red') #change colour
turtle_object.forward(50) #move forward by 50 units
turtle_object.left(90) #turn by 90 degrees
turtle_object.forward(30) #complete second side of a rectangle
